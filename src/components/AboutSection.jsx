                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                    <div className="space-y-6">
                        ...
                        <p className="text-muted-foreground">
                            I specialize in creating responsive and accessible web applications and dashboards.
                        </p>

                        <p className="text-muted-foreground">
                            I'm constantly learning, integrating the newest technologies and most up to date 
                            best practices into every web solution.
                        </p>
